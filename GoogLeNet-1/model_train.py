...
def train_val_data_process():
    # 定义数据集路径
    ROOT_TRAIN = r'GoogLeNet-1/data/train'
...
def train_model(model, train_dataloader,  val_dataloader, num_epochs):
    ...
    torch.save(best_model_wts, "GoogLeNet-1/best_model.pth")
...
if __name__ == "__main__":
    ...
    # 训练模型
    train_process = train_model(GoogLeNet, train_data, val_data, num_epochs=40)
    # 显示训练集和验证集的损失函数和准确率
